; ModuleID = 'test_initiation_interval_2.cpp_mem2reg_constprop.ll'
...
for.end:                                          ; preds = %for.body
  ...
  %call16 = call i32 @_Z26test_initiation_interval_2PiS_S_S_(i32* %arraydecay, i32* %arraydecay13, i32* %arraydecay14, i32* %arraydecay15)
  ret i32 0
}
