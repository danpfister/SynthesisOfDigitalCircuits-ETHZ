; ModuleID = 'test_resources_constraints_1.cpp_mem2reg_constprop_simplifycfg.ll'
source_filename = "src/test_resources_constraints_1.cpp"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind uwtable
define i32 @_Z28test_resources_constraints_1iiii(i32 %a, i32 %b, i32 %c, i32 %n) #0 {
entry:
  %add = add nsw i32 %b, 50
  %add1 = add nsw i32 %n, 100
  %mul = mul nsw i32 %add, %add1
  %add2 = add nsw i32 %c, 40
  %mul3 = mul nsw i32 %mul, %add2
  %add4 = add nsw i32 %a, 10
...
entry:
  ...
  %call7 = call i32 @_Z28test_resources_constraints_1iiii(i32 %rem, i32 %rem2, i32 %rem4, i32 %rem6)
  ret i32 0
}
