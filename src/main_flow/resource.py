...
class Resources:
	...
	def add_resource_constraints_pipelined(self, ilp, constraints, obj_function, budget):
		self.set_ilp_tuple(ilp, constraints, obj_function)
	...
	"""
	def check_resource_constraints(self, resource_dic):
